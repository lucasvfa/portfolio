...
// Hyperscript helper — creates virtual DOM nodes that Satori understands
...
export default async function handler(req) {
  ...
  // Load Inter fonts in parallel
  const [fontData, fontBold] = await Promise.all([
    fetch('https://fonts.gstatic.com/s/inter/v18/UcCO3FwrK3iLTeHuS_nVMrMxCp50SjIw2boKoduKmMEVuI6fAZ9hiA.woff2').then(function(r) { return r.arrayBuffer(); }),
    fetch('https://fonts.gstatic.com/s/inter/v18/UcCO3FwrK3iLTeHuS_nVMrMxCp50SjIw2boKoduKmMEVuFuYAZ9hiA.woff2').then(function(r) { return r.arrayBuffer(); }),
  ]);

  // Build the OG image layout: 1/3 branding | 2/3 project cover
  var element = h('div', {
    style: {
      display: 'flex',
      width: '1200px',
